<?php
    ...
    $finalkey = $_POST["finalkey"];
    $finalstage = $_POST["finalstage"];
    ...
    //$result = $conn->query($sql);
        ...
        // NEW SQL command
        $sql = "INSERT INTO users (username, finalscore, finalcoin, finalkey, finalstage) VALUES ('" . $loginUser ."', '" . $finalscore ."','" . $finalcoin ."','" . $finalkey ."','" . $finalstage ."')";
